...
public class Controller01_2 {
  ...
  public String handler1(Model model) {
    ...
    //    - *.properties 에서 뷰 이름에 해당하는 컴포넌트 URL을 찾는다.
    // => InternalResouceViewResolver
    //    - 미리 지정된 접두사, 접미사를 사용하여 뷰이름으로 컴포넌트의 URL을 완성한다.
    //
    // View?
    ...
    // view resolver는 자신의 정책에 맞춰서 해당 URL을 준비한다.
  ...
  // 테스트:
  //   http://localhost:8888/bitcamp-java-spring-webmvc/app2/c01_2/h2
  @GetMapping("h2") 
  ...
  // 테스트:
  //   http://localhost:8888/bitcamp-java-spring-webmvc/app2/c01_2/h3
  @GetMapping("h3") 
  ...
  public ModelAndView handler5() {
    ...
    // 프론트 컨트롤러는 ModelAndView 객체에 보관되어 있는 값들을
    // SErvletRequest 보관소로 옮기고,
    // 뷰 이름을 지정하지 않으면 request handler의 path를 Biewesolver에게 넘긴다.
    //
    return mv;
  }
