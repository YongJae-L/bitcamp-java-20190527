...
- /WEB-INF/app-servlet.xml 로 위치 이동 및 이름 변경
    ...
    - ContextLoaderListener 는 WevMVC 관련 애노테이션을 처리할 객체가 없기 때문에
...
## src.06 : ContextLoaderListener와 DispatcherServlet의 IoC 컨테이너
- ContextLoaderListener 의 IoC 컨테이너
...
- /WEB-INF/admin-servlet.xml 변경
- /WEB-INF/web.xml 변경

## src.07 : Java Config로 DispatcherServlet의 IoC 컨테이너 설정하기

- bitcamp.AppConfig.java 클래스 생성
- /WEB-INF/web.xml 변경

## src.08 : web.xml 대신 WebApplicaionInitializer 구현체의 활용

- Spring WebMVC의 WebApplicaionInitializer를 이해하기 위한 기반 기술 소개
- bitcamp-java-web-library 프로젝트 준비
- 자세한 내용은 해당 프로젝트의 README.md 파일 읽어볼 것
