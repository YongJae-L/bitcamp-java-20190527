...
import static org.reflections.ReflectionUtils.*; //해당 클래스의 모든 스테틱 메서드를 찾아라
...
public class DispatcherServlet extends HttpServlet {
  ...
  private Method findRequestHandler(Object obj) {
    Set<Method> methods = getMethods(obj.getClass(), withAnnotation(RequestMapping.class),withModifier(Modifier.PUBLIC)); // predicate 여러개 작성가능
