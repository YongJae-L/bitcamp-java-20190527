...
public class App {
  ...
  private void service() {
    ...
    // 애플리케이션의 서비스를 시작할 때 등록된 옵저거에게 알린다.
  ...
  public void addApplcationContextListener(ApplicationContextListener listener) {
  ...
  public static void main(String[] args) {
    ...
    app.addApplcationContextListener(new HelloApplicationContextListener());
    app.addApplcationContextListener(new DataLoaderListener());
