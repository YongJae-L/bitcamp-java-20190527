...
public class Test02 {
  public static void main(String[] args) {
    ...
    s2.setKor(100);//Score의 compute2() 호출 => 3과목의 합계와 평균 계산
    s2.setEng(100);//Score의 compute2() 호출 => 3과목의 합계와 평균 계산
    s2.setMath(100);//Score의 compute2() 호출 => 3과목의 합계와 평균 계산
