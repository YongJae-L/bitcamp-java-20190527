...
class Monitor4 {
  int bright=20; // 밝기 (0% ~ 100%)
  int contrast=20; // 명암 (0% ~ 100%)
  ...
  // 예 ) Monitor4()
  // => 파라미터 값을 안 받는 생성자(파라미터가 없는 생성자)를 "기본 생성자" 부른다.
  ...
  Monitor4() { // 생성자 <== 파라미터를 받지 않는 생성자를 기본 생성자(default constructor)라 부른다.
    ...
    // -생성자는 (인스턴스를 어떤 값으로 초기화해야 하는지) 외부에서 초기화 시킬 값을 받을 수 있다.
...
public class Test06 {
  public static void main(String[] args) {
    // 모니터 인스턴스 생성
    // 1)Monitor4 설계도에 따라 인스턴스 피드를 Heap에 생성한다.
    // 2) 필드의 초기화 문장을 실행한다.
    //    예) int bright = 10;
    // 3) 인스턴스 초기화 블록을 실행한다.
    //    예)
